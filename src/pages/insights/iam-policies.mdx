...
Welcome to more discussion about IAM policies. My previous post is on [AssumeRole and Trust Policies](https://www.ocelotconsulting.com/insights/assumerole-and-wizards) and a subtle hint at who I think should play Gandalf next. This one, we're going to dive into IAM policy structure and some examples to think about when designing them.
